                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        <h4 style="text-transform: none;">Listes des catégories</h4>
                                                        <span style="text-transform: none;">Trouvez ici la liste des catégories avec leurs informations générales.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive p-3">
                                                    <table id="liste" class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td><?= $cat[$i]['nom_categorie'] ?></td>
                                                            <td><?= $cat[$i]['heure'] ?></td>
                                                            <td><?= $cat[$i]['salaire'] ?></td>
                                                            <td><?= $cat[$i]['indemnite'] ?> %</td>
                                                            <td><a href="<?= base_url('Categorie/f_modifier/'.$cat[$i]['id_categorie']) ?>" class="btn btn-sm btn-primary">Modifier</a></td>
                                                        </tr>
                                                        <?php } ?>
                                                    </table>
                                                </div>
