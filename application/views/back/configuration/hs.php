                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive p-3">
                                                    <table id="liste" class="table table-bordered">
                                                        ...
                                                        <?php for($i=0; $i<count($hs); $i++) { ?>
                                                        <tr>
                                                            <td><?= $hs[$i]['designation'] ?></td>
                                                            <td><?= $hs[$i]['h_max'] ?></td>
                                                            <td><?= $hs[$i]['pourcentage'] ?> %</td>
                                                            <td><a href="<?= base_url('Configuration/f_modifier_hs/'.$hs[$i]['id_h_supplementaire']) ?>" class="btn btn-sm btn-primary">Modifier</a></td>
                                                        </tr>
                                                        <?php } ?>
                                                    </table>
                                                </div>
