                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card fb-card">
                                            ...
                                            <div class="card-block text-center">
                                                <form method="POST" action="<?= base_url('Configuration/modifier_hm') ?>">
                                                    <input type="hidden" name="id_h_majoree" value="<?= $hm['id_h_majoree'] ?>">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="designation" value="<?= $hm['designation'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">pourcentage</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="pourcentage" value="<?= $hm['pourcentage'] ?>">
                                                        </div>
                                                    </div>
